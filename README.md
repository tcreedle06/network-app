...
•Possible numeric server replies:
•RPL_NAMREPLY
•RPL_ENDOFNAME Returns all the nicknames of the specified channels. The <channel>
parameter specifies which channel(s) to return information about if valid. There is no error reply for
bad channel names.

If no <channel> parameter is given, a list of all channels and their occupants is returned. At the end of this list, a
